...
public class one_to_one_scheduler implements IScheduler{
	...
	//have changed the testingworker supervisor to superone
	    ...
	    public void schedule(Topologies topologies, Cluster cluster) {
	        ...
	        TopologyDetails topology = topologies.getByName("trending");
	        ...
	        if (topology != null) {
	            ...
	            if (!needsScheduling) {
	                ...
	                if (!componentToExecutors.containsKey("TrendingTopicwithFrequency")) {
	                	System.out.println("Our special-spout DOES NOT NEED scheduling.");
	                } else {
	                    System.out.println("Our TrendingTopicwithFrequencyneeds scheduling.");
	                    List<ExecutorDetails> executors = componentToExecutors.get("TrendingTopicwithFrequency");
	                    ...
	                    for (SupervisorDetails supervisor : supervisors) {
	                        ...
	                        if (meta.get("name").equals("superone")) {
